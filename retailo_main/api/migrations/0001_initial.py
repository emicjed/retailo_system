...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('purpose', models.CharField(choices=[('LOGIN', 'Login 2FA'), ('RESET', 'Password reset'), ('PWD_CHANGE', 'Password change')], default='LOGIN', max_length=50)),
            ...
            options={
                'indexes': [models.Index(fields=['user', 'purpose'], name='api_emailot_user_id_3d04f8_idx'), models.Index(fields=['expires_at'], name='api_emailot_expires_037b79_idx'), models.Index(fields=['created_at'], name='api_emailot_created_6b0139_idx')],
            },
        ),
        migrations.CreateModel(
            name='Authorization',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('initial_password_encrypted', models.BinaryField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('module', models.CharField(choices=[('administration', 'Panel administracyjny'), ('orders', 'Zamówienia'), ('workers', 'Pracwonicy'), ('devices', 'Urądzenia'), ('customers', 'Klienci')], db_index=True, max_length=32)),
